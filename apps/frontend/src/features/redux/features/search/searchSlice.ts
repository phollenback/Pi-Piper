...
// Search Slice manages the search state. This allows me to keep the search bar in the nav bar, seperate
// from the rest of the pages. The way, the pages could be simplified by just having to "select" the search
// key from the search slice, instead of having to pass it down through props.
