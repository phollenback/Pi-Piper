(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__958941._.js", {
...
const authConfig = {
    ...
    callbacks: {
        authorized ({ auth, request: { nextUrl } }) {
            ...
            const isManagerPath = nextUrl.pathname.startsWith('/manager-dash');
            const isPrepPath = nextUrl.pathname.startsWith('/prep-dash');
            if (isManagerPath) {
                return isLoggedIn && auth?.user?.role === 'manager';
            } else if (isPrepPath) {
                return isLoggedIn;
            }
            return true;
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"])({
            async authorize (credentials) {
                const parsedCredentials = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["z"].object({
                    username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["z"].string().min(1),
                    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["z"].string().min(1),
                    restaurant_id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["z"].string(),
                    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["z"].enum([
                        'manager',
                        'prep'
                    ])
                ...
                const mockUser = {
                    ...
                    role: parsedCredentials.data.role,
                    restaurant_id: parseInt(parsedCredentials.data.restaurant_id)
                };
                return mockUser;
            }
        })
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__958941._.js.map