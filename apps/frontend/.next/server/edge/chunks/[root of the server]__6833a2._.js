(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__6833a2._.js", {
...
;
;
const { auth, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    providers: [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/auth.ts [middleware] (ecmascript)");
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["auth"])((req)=>{
    const isLoggedIn = !!req.auth;
    const isManagerRoute = req.nextUrl.pathname.startsWith('/manager-dash');
    const isPrepRoute = req.nextUrl.pathname.startsWith('/prep-dash');
    if (!isLoggedIn && (isManagerRoute || isPrepRoute)) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6833a2._.js.map