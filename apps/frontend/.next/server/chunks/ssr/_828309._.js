...
function GrouperPage() {
    ...
    const { data: ingredientItems = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$PrepDash$2f$Grouper$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getIngredients"])(RESTAURANT_ID),
    ...
    const { data: prepItems = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$PrepDash$2f$Grouper$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPrepItems"])(RESTAURANT_ID),
        enabled: selectedType === 'prep_items'
    });
    const currentItems = selectedType === 'ingredients' ? ingredientItems : prepItems;
    const filteredItems = selectedCategory ? currentItems.filter((item)=>selectedType === 'ingredients' ? item.ingredientCategory === selectedCategory : item.category === selectedCategory) : currentItems;
    ...
    const handleCreateGroup = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$PrepDash$2f$Grouper$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createGroup"])(groupName, RESTAURANT_ID, mappedItems);
...
//# sourceMappingURL=_828309._.js.map