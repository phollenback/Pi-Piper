...
export type RestaurantSettingsInsert = InferModel<typeof dimRestaurantSettings, 'insert'>;
...
export type DateRecord = InferSelectModel<typeof dimDate>;
...
export type RestaurantSettings = InferSelectModel<typeof dimRestaurantSettings>;
