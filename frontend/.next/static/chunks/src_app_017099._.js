(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_017099._.js", {
...
const DailyPrepList = ({ list, handleCardClick })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-3 max-h-[650px] overflow-y-auto",
        children: [
            " ",
...
const Kanban = ({ prepItems, category })=>{
    ...
    const handleCardClick = (prepItem)=>{
        ...
        if (updatedItem.status === 'complete') {
            ...
            setCompleteItems((prevCompletes)=>[
                    ...prevCompletes,
                    updatedItem
                ]);
        } else {
...
_s(Kanban, "RqSuIcyZQhwoq/O5bxPFzw0J664=");
_c = Kanban;
...
//# sourceMappingURL=src_app_017099._.js.map