...
_s(Heading, "a6YqUoPU0he+x9nIHfYdErJENrE=");
_c = Heading;
...
const ManagementTable = ({ activeList, category, activeSection })=>{
    ...
    const [activeInSection, setSection] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
...
_s(ManagementTable, "PmIEYCAjNqkRoN2yg6oVjEscjTM=", false, function() {
    return [
...
_s(CreateItem, "ZyVOWWRSWnQj8Dq/aT5dAd/YFPM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
