(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_31ab66._.js", {
        ...
        queryFn: {
            "useRecipe.useQuery": async ()=>{
                ...
                const recipe = mockRecipes.find({
                    "useRecipe.useQuery.recipe": (recipe)=>recipe.prepItemId === recipeId
                }["useRecipe.useQuery.recipe"]);
                if (!recipe) {
...
"[project]/src/app/hooks/useCategories.ts [app-client] (ecmascript)": (function(__turbopack_context__) {
...
function RecipeBookContainer() {
    ...
    const restaurantId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "RecipeBookContainer.useSelector[restaurantId]": (state)=>state.auth.user?.restaurantId
    }["RecipeBookContainer.useSelector[restaurantId]"]);
...
_s(RecipeBookContainer, "1rLL/9dp9fqmv/8shxQOKm69xN4=", false, function() {
    return [
...
//# sourceMappingURL=_31ab66._.js.map