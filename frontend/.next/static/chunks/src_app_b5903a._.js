...
_s(DailyPrepItem, "qImOL+Mua8vqu8HQK+DYJtK3gUo=");
_c = DailyPrepItem;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Kanban.useEffect": ()=>{
            ...
            setTodoItems(filteredItems.filter({
                "Kanban.useEffect": (item)=>item.status === "todo" || item.status === "in-progress"
            }["Kanban.useEffect"]));
            // Update completeItems to include only items with status 'complete'
            setCompleteItems(filteredItems.filter({
                "Kanban.useEffect": (item)=>item.status === "complete"
            }["Kanban.useEffect"]));
        }
    }["Kanban.useEffect"], [
        prepItems,
...
_s(Kanban, "wYHwlN4E//a8bIgtN8W8kH6FxT4=", false, function() {
    return [
...
function PrepContainer() {
    ...
    const { data: dailyPrepList = [], isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "prepItems"
        ],
        queryFn: {
            "PrepContainer.useQuery": async ()=>{
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$prepItemActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchDailyList"])(1);
...
_s(PrepContainer, "O8iTGRLEzXRqwi3nbbV7N0D85FA=", false, function() {
    return [
