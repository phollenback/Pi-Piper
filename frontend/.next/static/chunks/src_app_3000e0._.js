(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_3000e0._.js", {
...
const fetchDepProgress = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3000/departments/daily/1');
...
_s(DepartmentProgress, "Q2Pj3USUYw0hO8a8mvlZx1UNBhk=", false, function() {
    return [
...
"[project]/src/app/components/ManagerDash/Dash/TimeVariables.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const TimeVariables = ()=>{
    _s();
    const [currentTime, setCurrentTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Date()); // Current time.
    const [timeUntilNoon, setTimeUntilNoon] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // Time until noon.
    // Updates the currentTime state every second.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TimeVariables.useEffect": ()=>{
            const interval = setInterval({
                "TimeVariables.useEffect.interval": ()=>{
                    setCurrentTime(new Date());
                }
            }["TimeVariables.useEffect.interval"], 1000);
            return ({
                "TimeVariables.useEffect": ()=>clearInterval(interval)
            })["TimeVariables.useEffect"];
        }
    }["TimeVariables.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TimeVariables.useEffect": ()=>{
            const calculateTimeUntilNoon = {
                "TimeVariables.useEffect.calculateTimeUntilNoon": ()=>{
                    const now = new Date();
                    const noon = new Date();
...
_s(TimeVariables, "I3rHMKBExfn0t/41N9Dn3hLIJWA=");
_c = TimeVariables;
const __TURBOPACK__default__export__ = TimeVariables;
var _c;
__turbopack_refresh__.register(_c, "TimeVariables");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_3000e0._.js.map