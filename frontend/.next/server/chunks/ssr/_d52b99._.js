...
(()=>{
    const e = new Error("Cannot find module '@/app/hooks/useCategories'");
...
function RecipeBookContainer() {
    ...
    const restaurantId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.auth.user?.restaurantId);
...
//# sourceMappingURL=_d52b99._.js.map