...
const RecipeDisplay = ({ selectedRecipe })=>{
    ...
    // Extract procedure from description or use a default message
...
const mockRecipes = [
    {
        prepItemId: 1,
        prepItemName: "Spaghetti Bolognese",
        ...
        procedure: "1. Cook spaghetti. 2. Prepare sauce."
    },
    {
        prepItemId: 2,
        prepItemName: "Chicken Caesar Salad",
        ...
        procedure: "1. Grill chicken. 2. Toss salad."
    }
];
...
const useRecipe = (recipeId)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            // Return mock data for now
            const recipe = mockRecipes.find((recipe)=>recipe.prepItemId === recipeId);
            if (!recipe) {
...
const useCategories = (restaurantId)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/api/categories', {
                params: {
                    restaurantId
                }
            });
...
function RecipeBookContainer() {
    ...
    let restaurantId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.auth.restaurantId);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9881f1._.js.map