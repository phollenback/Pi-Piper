...
const ManagementTable = ({ activeList, category, activeSection })=>{
    ...
    const [, setSection] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const filteredList = (list = [])=>list.filter((item)=>{
            ...
            if ("prep_item_name" in item) {
                matchesSearchTerm = item.prep_item_name.toLowerCase().includes(lowercasedTerm) || item.description.toLowerCase().includes(lowercasedTerm) || item.kitchen_department_id.toString().includes(lowercasedTerm) || item.category.toString().includes(lowercasedTerm);
    ...
    const renderList = ()=>{
        ...
        const isPrepItem = (item)=>item.prep_item_name !== undefined;
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-[50%] flex items-right justify-right pl-12 border-l-8 border-r-8 border-black",
