...
const IngredientRow = ({ item, categoryOptions })=>{
    ...
    const handleConfirmDelete = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ManagerDash$2f$PrepManager$2f$Table$2f$Ingredient$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteIngredient"])(item.ingredient_id, item.restaurant_id);
            setIsDeleteModalOpen(false);
...
const PrepItemRow = ({ item, categoryOptions, departmentOptions })=>{
    ...
    const handleConfirmDelete = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ManagerDash$2f$PrepManager$2f$Table$2f$PrepItem$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deletePrepItem"])(item.prep_item_id, 1);
            setIsDeleteModalOpen(false);
        // Optionally, you can add a callback to refresh the list after deletion
        } catch (error) {
...
function PrepManagerContainer() {
    const [selectedCategory, setSelectedCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Selected category ID.
...
//# sourceMappingURL=src_app_cdb0b4._.js.map