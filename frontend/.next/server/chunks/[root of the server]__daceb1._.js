...
const authConfig = {
    ...
    callbacks: {
        authorized ({ auth, request: { nextUrl } }) {
            ...
            const isProtectedRoute = nextUrl.pathname.startsWith('/manager-dash') || nextUrl.pathname.startsWith('/prep-dash');
            if (isProtectedRoute) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/auth.ts [app-route] (ecmascript)");
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__daceb1._.js.map